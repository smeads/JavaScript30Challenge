...
module.exports = {
  ...
  output: {
    path: __dirname, // path is the absolute path, i.e. the full name of the directory where our build is stored. __dirname is a built in node.js variable that maps to the current directory.
